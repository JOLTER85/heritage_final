    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-0">
        <div className="bg-primary text-white p-16 flex flex-col justify-center">
          ...
          <Link to="/reports" className="w-fit border border-white/30 px-6 py-2 hover:bg-white/10 transition-colors">
            Technical Reports
          </Link>
        </div>
        <div className="bg-heritage-slate text-white p-16 flex flex-col justify-center">
          ...
          <Link to="/studies" className="w-fit border border-white/30 px-6 py-2 hover:bg-white/10 transition-colors">
            Ecological Studies
          </Link>
        </div>
      </div>
